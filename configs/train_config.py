...
MODEL = 'DeepLab'  #RefineNetPSPNet, DeepLab, RefineNet,deeplabv3plus
...
DATA_DIRECTORY = './data/DANNet/cityscapes/'
DATA_LIST_PATH = './dataset/lists/cityscapes_train.txt'

DATA_DIRECTORY_ACDC = './data/DANNet/ACDC/'
DATA_LIST_PATH_ACDC_NIGHT = './dataset/lists/acdc_night_train1.txt'
DATA_LIST_PATH_ACDC_FOG = './dataset/lists/acdc_fog_train.txt'

DATA_DIRECTORY_NIGHTCITY = './data/DANNet/NightCity-images/'
DATA_LIST_PATH_NIGHTCITY = './dataset/lists/nightcity_train1.txt'

INPUT_SIZE = '512'
DATA_DIRECTORY_TARGET = './data/DANNet/Dark_Zurich_train_anon/rgb_anon/'
...
SNAPSHOT_DIR = './data/DANNet/snapshots/'+MODEL +'/un+'
STD = 0.05
...
def get_arguments():
    ...
    parser.add_argument("--data-list-acdc-night", type=str, default=DATA_LIST_PATH_ACDC_NIGHT,
                        help="Path to the file listing the images in the source dataset.")
    parser.add_argument("--data-list-acdc-fog", type=str, default=DATA_LIST_PATH_ACDC_FOG,
                        help="Path to the file listing the images in the source dataset.")
